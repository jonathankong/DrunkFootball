...
public class IntReferenceEditor : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (useConstant == null)
        {
            useConstant = property.FindPropertyRelative(nameof(IntReference.UseConstant));
            constantValue = property.FindPropertyRelative(nameof(IntReference.ConstantValue));
            variable = property.FindPropertyRelative(nameof(IntReference.Variable));
        }
